...
# Ensure `import src.*` works whether run directly or via `python -m`.
...
def main(cfg: DictConfig) -> None:
    ...
    # cudnn.benchmark + TF32 high: marginal gains on long-sequence pulsedb,
    # safe under non-deterministic mode.
